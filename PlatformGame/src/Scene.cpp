...
bool Scene::Awake()
{
	...
	SDL_Rect btPos2 = { 200 , 150 , 120, 60 };
	SDL_Rect btPos3 = { 200 , 200 , 120, 60 };
	SDL_Rect btPos4 = { 200 , 250 , 120, 60 };
	...
	guiCredits = (GuiControlButton*)Engine::GetInstance().guiManager->CreateGuiControl(GuiControlType::BUTTON, 3, "CREDITS", btPos3, this);
	guiExit = (GuiControlButton*)Engine::GetInstance().guiManager->CreateGuiControl(GuiControlType::BUTTON, 4, "EXIT", btPos4, this);
	return ret;
}
